...
if(clearJointErrorDuration > 0)
    gaitCommands = [ JointCommand.RESOLVEERROR; JointCommand.RESOLVEERROR; JointCommand.RESOLVEERROR; JointCommand.RESOLVEERROR ];
...
switch(masterState)
   ...
   case ExoskeletonState.STANDINGUP
    ...
    case ExoskeletonState.STAIRSDOWN
        jointCommands = gaitCommands;
    case ExoskeletonState.SLOPEUP
        jointCommands = gaitCommands;
    case ExoskeletonState.SLOPEDOWN
        jointCommands = gaitCommands;
