...
bio(3).dim=[1,1];
bio(3).sigWidth=1;
bio(3).sigAddress='&gait_recorder_B.EtherCATPDOReceive';
bio(3).ndims=2;
bio(3).size=[];
...
bio(4).dim=[1,1];
bio(4).sigWidth=1;
bio(4).sigAddress='&gait_recorder_B.EtherCATPDOReceive1';
bio(4).ndims=2;
bio(4).size=[];
...
bio(5).dim=[1,1];
bio(5).sigWidth=1;
bio(5).sigAddress='&gait_recorder_B.EtherCATPDOReceive2';
bio(5).ndims=2;
bio(5).size=[];
...
bio(6).dim=[1,1];
bio(6).sigWidth=1;
bio(6).sigAddress='&gait_recorder_B.EtherCATPDOReceive3';
bio(6).ndims=2;
bio(6).size=[];
