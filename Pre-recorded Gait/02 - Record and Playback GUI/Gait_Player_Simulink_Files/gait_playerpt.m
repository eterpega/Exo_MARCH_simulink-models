...
pt(7).blockname = 'Sat RKFE';
pt(7).paramname = 'UpperLimit';
pt(7).class     = 'scalar';
pt(7).nrows     = 1;
pt(7).ncols     = 1;
...
pt(8).blockname = 'Sat RKFE';
pt(8).paramname = 'LowerLimit';
pt(8).class     = 'scalar';
pt(8).nrows     = 1;
pt(8).ncols     = 1;
...
pt(9).blockname = 'Instrument Panel LHFE/Constant1';
...
pt(10).blockname = 'Instrument Panel LHFE/D';
...
pt(11).blockname = 'Instrument Panel LHFE/I';
pt(11).paramname = 'Value';
pt(11).class     = 'scalar';
pt(11).nrows     = 1;
pt(11).ncols     = 1;
pt(11).subsource = 'SS_SINGLE';
pt(11).ndims     = '2';
pt(11).size      = '[]';
...
pt(12).blockname = 'Instrument Panel LHFE/P';
...
pt(13).blockname = 'Instrument Panel LHFE/velocity setpoint';
pt(13).paramname = 'Value';
pt(13).class     = 'scalar';
pt(13).nrows     = 1;
pt(13).ncols     = 1;
pt(13).subsource = 'SS_INT16';
pt(13).ndims     = '2';
pt(13).size      = '[]';
...
pt(14).blockname = 'Instrument Panel LHFE/velocityOverrideFlag';
...
pt(15).blockname = 'Instrument Panel LHFE/Gain';
...
pt(16).blockname = 'Instrument Panel LHFE/Gain1';
...
pt(17).blockname = 'Instrument Panel LHFE/Gain2';
...
pt(18).blockname = 'Instrument Panel LKFE/Constant3';
...
pt(19).blockname = 'Instrument Panel LKFE/D1';
...
pt(20).blockname = 'Instrument Panel LKFE/I1';
pt(20).paramname = 'Value';
pt(20).class     = 'scalar';
pt(20).nrows     = 1;
pt(20).ncols     = 1;
pt(20).subsource = 'SS_SINGLE';
pt(20).ndims     = '2';
pt(20).size      = '[]';
...
pt(21).blockname = 'Instrument Panel LKFE/P1';
pt(21).paramname = 'Value';
pt(21).class     = 'scalar';
pt(21).nrows     = 1;
pt(21).ncols     = 1;
pt(21).subsource = 'SS_SINGLE';
pt(21).ndims     = '2';
pt(21).size      = '[]';
...
pt(22).blockname = 'Instrument Panel LKFE/velocity setpoint1';
pt(22).paramname = 'Value';
pt(22).class     = 'scalar';
pt(22).nrows     = 1;
pt(22).ncols     = 1;
pt(22).subsource = 'SS_INT16';
pt(22).ndims     = '2';
pt(22).size      = '[]';
...
pt(23).blockname = 'Instrument Panel LKFE/velocityOverrideFlag';
...
pt(24).blockname = 'Instrument Panel LKFE/Gain3';
pt(24).paramname = 'Gain';
pt(24).class     = 'scalar';
pt(24).nrows     = 1;
pt(24).ncols     = 1;
pt(24).subsource = 'SS_SINGLE';
pt(24).ndims     = '2';
pt(24).size      = '[]';
...
pt(25).blockname = 'Instrument Panel LKFE/Gain4';
...
pt(26).blockname = 'Instrument Panel LKFE/Gain5';
...
pt(27).blockname = 'Instrument Panel RHFE/Constant1';
...
pt(28).blockname = 'Instrument Panel RHFE/D';
...
pt(29).blockname = 'Instrument Panel RHFE/I';
...
pt(30).blockname = 'Instrument Panel RHFE/P';
...
pt(31).blockname = 'Instrument Panel RHFE/velocity setpoint';
pt(31).paramname = 'Value';
pt(31).class     = 'scalar';
pt(31).nrows     = 1;
pt(31).ncols     = 1;
pt(31).subsource = 'SS_INT16';
pt(31).ndims     = '2';
pt(31).size      = '[]';
...
pt(32).blockname = 'Instrument Panel RHFE/velocityOverrideFlag';
pt(32).paramname = 'Value';
pt(32).class     = 'scalar';
pt(32).nrows     = 1;
pt(32).ncols     = 1;
pt(32).subsource = 'SS_UINT32';
pt(32).ndims     = '2';
pt(32).size      = '[]';
...
pt(33).blockname = 'Instrument Panel RHFE/Gain';
...
pt(34).blockname = 'Instrument Panel RHFE/Gain1';
...
pt(35).blockname = 'Instrument Panel RHFE/Gain2';
...
pt(36).blockname = 'Instrument Panel RKFE/Constant3';
...
pt(37).blockname = 'Instrument Panel RKFE/D1';
...
pt(38).blockname = 'Instrument Panel RKFE/I1';
...
pt(39).blockname = 'Instrument Panel RKFE/P1';
...
pt(40).blockname = 'Instrument Panel RKFE/velocity setpoint1';
pt(40).paramname = 'Value';
pt(40).class     = 'scalar';
pt(40).nrows     = 1;
pt(40).ncols     = 1;
pt(40).subsource = 'SS_INT16';
pt(40).ndims     = '2';
pt(40).size      = '[]';
...
pt(41).blockname = 'Instrument Panel RKFE/velocityOverrideFlag';
...
pt(42).blockname = 'Instrument Panel RKFE/Gain3';
...
pt(43).blockname = 'Instrument Panel RKFE/Gain4';
...
pt(44).blockname = 'Instrument Panel RKFE/Gain5';
pt(44).paramname = 'Gain';
pt(44).class     = 'scalar';
pt(44).nrows     = 1;
pt(44).ncols     = 1;
pt(44).subsource = 'SS_SINGLE';
pt(44).ndims     = '2';
pt(44).size      = '[]';
...
pt(46).blockname = 'LHFE/EtherCAT PDO Receive';
pt(46).paramname = 'P2';
pt(46).class     = 'scalar';
pt(46).nrows     = 1;
pt(46).ncols     = 1;
...
pt(47).blockname = 'LHFE/EtherCAT PDO Receive';
pt(47).paramname = 'P3';
pt(47).class     = 'scalar';
pt(47).nrows     = 1;
pt(47).ncols     = 1;
...
pt(48).blockname = 'LHFE/EtherCAT PDO Receive';
pt(48).paramname = 'P4';
pt(48).class     = 'scalar';
pt(48).nrows     = 1;
pt(48).ncols     = 1;
...
pt(49).blockname = 'LHFE/EtherCAT PDO Receive';
pt(49).paramname = 'P5';
pt(49).class     = 'scalar';
pt(49).nrows     = 1;
pt(49).ncols     = 1;
...
pt(50).blockname = 'LHFE/EtherCAT PDO Receive';
pt(50).paramname = 'P6';
pt(50).class     = 'scalar';
pt(50).nrows     = 1;
pt(50).ncols     = 1;
...
pt(51).blockname = 'LHFE/EtherCAT PDO Receive';
pt(51).paramname = 'P7';
pt(51).class     = 'scalar';
pt(51).nrows     = 1;
pt(51).ncols     = 1;
...
pt(53).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(53).paramname = 'P2';
pt(53).class     = 'scalar';
pt(53).nrows     = 1;
pt(53).ncols     = 1;
...
pt(54).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(54).paramname = 'P3';
pt(54).class     = 'scalar';
pt(54).nrows     = 1;
pt(54).ncols     = 1;
...
pt(55).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(55).paramname = 'P4';
pt(55).class     = 'scalar';
pt(55).nrows     = 1;
pt(55).ncols     = 1;
...
pt(56).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(56).paramname = 'P5';
pt(56).class     = 'scalar';
pt(56).nrows     = 1;
pt(56).ncols     = 1;
...
pt(57).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(57).paramname = 'P6';
pt(57).class     = 'scalar';
pt(57).nrows     = 1;
pt(57).ncols     = 1;
...
pt(58).blockname = 'LHFE/EtherCAT PDO Receive1';
pt(58).paramname = 'P7';
pt(58).class     = 'scalar';
pt(58).nrows     = 1;
pt(58).ncols     = 1;
...
pt(60).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(60).paramname = 'P2';
pt(60).class     = 'scalar';
pt(60).nrows     = 1;
pt(60).ncols     = 1;
...
pt(61).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(61).paramname = 'P3';
pt(61).class     = 'scalar';
pt(61).nrows     = 1;
pt(61).ncols     = 1;
...
pt(62).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(62).paramname = 'P4';
pt(62).class     = 'scalar';
pt(62).nrows     = 1;
pt(62).ncols     = 1;
...
pt(63).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(63).paramname = 'P5';
pt(63).class     = 'scalar';
pt(63).nrows     = 1;
pt(63).ncols     = 1;
...
pt(64).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(64).paramname = 'P6';
pt(64).class     = 'scalar';
pt(64).nrows     = 1;
pt(64).ncols     = 1;
...
pt(65).blockname = 'LHFE/EtherCAT PDO Receive2';
pt(65).paramname = 'P7';
pt(65).class     = 'scalar';
pt(65).nrows     = 1;
pt(65).ncols     = 1;
...
pt(67).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(67).paramname = 'P2';
pt(67).class     = 'scalar';
pt(67).nrows     = 1;
pt(67).ncols     = 1;
...
pt(68).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(68).paramname = 'P3';
pt(68).class     = 'scalar';
pt(68).nrows     = 1;
pt(68).ncols     = 1;
...
pt(69).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(69).paramname = 'P4';
pt(69).class     = 'scalar';
pt(69).nrows     = 1;
pt(69).ncols     = 1;
...
pt(70).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(70).paramname = 'P5';
pt(70).class     = 'scalar';
pt(70).nrows     = 1;
pt(70).ncols     = 1;
...
pt(71).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(71).paramname = 'P6';
pt(71).class     = 'scalar';
pt(71).nrows     = 1;
pt(71).ncols     = 1;
...
pt(72).blockname = 'LHFE/EtherCAT PDO Transmit ';
pt(72).paramname = 'P7';
pt(72).class     = 'scalar';
pt(72).nrows     = 1;
pt(72).ncols     = 1;
...
pt(74).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(74).paramname = 'P2';
pt(74).class     = 'scalar';
pt(74).nrows     = 1;
pt(74).ncols     = 1;
...
pt(75).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(75).paramname = 'P3';
pt(75).class     = 'scalar';
pt(75).nrows     = 1;
pt(75).ncols     = 1;
...
pt(76).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(76).paramname = 'P4';
pt(76).class     = 'scalar';
pt(76).nrows     = 1;
pt(76).ncols     = 1;
...
pt(77).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(77).paramname = 'P5';
pt(77).class     = 'scalar';
pt(77).nrows     = 1;
pt(77).ncols     = 1;
...
pt(78).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(78).paramname = 'P6';
pt(78).class     = 'scalar';
pt(78).nrows     = 1;
pt(78).ncols     = 1;
...
pt(79).blockname = 'LHFE/EtherCAT PDO Transmit 1';
pt(79).paramname = 'P7';
pt(79).class     = 'scalar';
pt(79).nrows     = 1;
pt(79).ncols     = 1;
...
pt(81).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(81).paramname = 'P2';
pt(81).class     = 'scalar';
pt(81).nrows     = 1;
pt(81).ncols     = 1;
...
pt(82).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(82).paramname = 'P3';
pt(82).class     = 'scalar';
pt(82).nrows     = 1;
pt(82).ncols     = 1;
...
pt(83).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(83).paramname = 'P4';
pt(83).class     = 'scalar';
pt(83).nrows     = 1;
pt(83).ncols     = 1;
...
pt(84).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(84).paramname = 'P5';
pt(84).class     = 'scalar';
pt(84).nrows     = 1;
pt(84).ncols     = 1;
...
pt(85).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(85).paramname = 'P6';
pt(85).class     = 'scalar';
pt(85).nrows     = 1;
pt(85).ncols     = 1;
...
pt(86).blockname = 'LHFE/EtherCAT PDO Transmit 2';
pt(86).paramname = 'P7';
pt(86).class     = 'scalar';
pt(86).nrows     = 1;
pt(86).ncols     = 1;
...
pt(88).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(88).paramname = 'P2';
pt(88).class     = 'scalar';
pt(88).nrows     = 1;
pt(88).ncols     = 1;
...
pt(89).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(89).paramname = 'P3';
pt(89).class     = 'scalar';
pt(89).nrows     = 1;
pt(89).ncols     = 1;
...
pt(90).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(90).paramname = 'P4';
pt(90).class     = 'scalar';
pt(90).nrows     = 1;
pt(90).ncols     = 1;
...
pt(91).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(91).paramname = 'P5';
pt(91).class     = 'scalar';
pt(91).nrows     = 1;
pt(91).ncols     = 1;
...
pt(92).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(92).paramname = 'P6';
pt(92).class     = 'scalar';
pt(92).nrows     = 1;
pt(92).ncols     = 1;
...
pt(93).blockname = 'LHFE/EtherCAT PDO Transmit 3';
pt(93).paramname = 'P7';
pt(93).class     = 'scalar';
pt(93).nrows     = 1;
pt(93).ncols     = 1;
...
pt(95).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(95).paramname = 'P2';
pt(95).class     = 'scalar';
pt(95).nrows     = 1;
pt(95).ncols     = 1;
...
pt(96).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(96).paramname = 'P3';
pt(96).class     = 'scalar';
pt(96).nrows     = 1;
pt(96).ncols     = 1;
...
pt(97).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(97).paramname = 'P4';
pt(97).class     = 'scalar';
pt(97).nrows     = 1;
pt(97).ncols     = 1;
...
pt(98).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(98).paramname = 'P5';
pt(98).class     = 'scalar';
pt(98).nrows     = 1;
pt(98).ncols     = 1;
...
pt(99).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(99).paramname = 'P6';
pt(99).class     = 'scalar';
pt(99).nrows     = 1;
pt(99).ncols     = 1;
...
pt(100).blockname = 'LHFE/EtherCAT PDO Transmit 4';
pt(100).paramname = 'P7';
pt(100).class     = 'scalar';
pt(100).nrows     = 1;
pt(100).ncols     = 1;
...
pt(102).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(102).paramname = 'P2';
pt(102).class     = 'scalar';
pt(102).nrows     = 1;
pt(102).ncols     = 1;
...
pt(103).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(103).paramname = 'P3';
pt(103).class     = 'scalar';
pt(103).nrows     = 1;
pt(103).ncols     = 1;
...
pt(104).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(104).paramname = 'P4';
pt(104).class     = 'scalar';
pt(104).nrows     = 1;
pt(104).ncols     = 1;
...
pt(105).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(105).paramname = 'P5';
pt(105).class     = 'scalar';
pt(105).nrows     = 1;
pt(105).ncols     = 1;
...
pt(106).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(106).paramname = 'P6';
pt(106).class     = 'scalar';
pt(106).nrows     = 1;
pt(106).ncols     = 1;
...
pt(107).blockname = 'LHFE/EtherCAT PDO Transmit 5';
pt(107).paramname = 'P7';
pt(107).class     = 'scalar';
pt(107).nrows     = 1;
pt(107).ncols     = 1;
...
pt(111).blockname = 'LKFE/EtherCAT PDO Receive';
pt(111).paramname = 'P4';
pt(111).class     = 'scalar';
pt(111).nrows     = 1;
pt(111).ncols     = 1;
...
pt(112).blockname = 'LKFE/EtherCAT PDO Receive';
pt(112).paramname = 'P5';
pt(112).class     = 'scalar';
pt(112).nrows     = 1;
pt(112).ncols     = 1;
...
pt(113).blockname = 'LKFE/EtherCAT PDO Receive';
pt(113).paramname = 'P6';
pt(113).class     = 'scalar';
pt(113).nrows     = 1;
pt(113).ncols     = 1;
...
pt(114).blockname = 'LKFE/EtherCAT PDO Receive';
pt(114).paramname = 'P7';
pt(114).class     = 'scalar';
pt(114).nrows     = 1;
pt(114).ncols     = 1;
...
pt(115).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(115).paramname = 'P1';
pt(115).class     = 'vector';
pt(115).nrows     = 1;
pt(115).ncols     = 26;
...
pt(116).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(116).paramname = 'P2';
pt(116).class     = 'scalar';
pt(116).nrows     = 1;
pt(116).ncols     = 1;
...
pt(117).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(117).paramname = 'P3';
pt(117).class     = 'scalar';
pt(117).nrows     = 1;
pt(117).ncols     = 1;
...
pt(118).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(118).paramname = 'P4';
pt(118).class     = 'scalar';
pt(118).nrows     = 1;
pt(118).ncols     = 1;
...
pt(119).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(119).paramname = 'P5';
pt(119).class     = 'scalar';
pt(119).nrows     = 1;
pt(119).ncols     = 1;
...
pt(120).blockname = 'LKFE/EtherCAT PDO Transmit ';
pt(120).paramname = 'P6';
pt(120).class     = 'scalar';
pt(120).nrows     = 1;
pt(120).ncols     = 1;
...
pt(122).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(122).paramname = 'P1';
pt(122).class     = 'vector';
pt(122).nrows     = 1;
pt(122).ncols     = 18;
...
pt(123).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(123).paramname = 'P2';
pt(123).class     = 'scalar';
pt(123).nrows     = 1;
pt(123).ncols     = 1;
...
pt(124).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(124).paramname = 'P3';
pt(124).class     = 'scalar';
pt(124).nrows     = 1;
pt(124).ncols     = 1;
...
pt(125).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(125).paramname = 'P4';
pt(125).class     = 'scalar';
pt(125).nrows     = 1;
pt(125).ncols     = 1;
...
pt(126).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(126).paramname = 'P5';
pt(126).class     = 'scalar';
pt(126).nrows     = 1;
pt(126).ncols     = 1;
...
pt(127).blockname = 'LKFE/EtherCAT PDO Transmit 1';
pt(127).paramname = 'P6';
pt(127).class     = 'scalar';
pt(127).nrows     = 1;
pt(127).ncols     = 1;
...
pt(129).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(129).paramname = 'P1';
pt(129).class     = 'vector';
pt(129).nrows     = 1;
pt(129).ncols     = 18;
...
pt(130).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(130).paramname = 'P2';
pt(130).class     = 'scalar';
pt(130).nrows     = 1;
pt(130).ncols     = 1;
...
pt(131).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(131).paramname = 'P3';
pt(131).class     = 'scalar';
pt(131).nrows     = 1;
pt(131).ncols     = 1;
...
pt(132).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(132).paramname = 'P4';
pt(132).class     = 'scalar';
pt(132).nrows     = 1;
pt(132).ncols     = 1;
...
pt(133).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(133).paramname = 'P5';
pt(133).class     = 'scalar';
pt(133).nrows     = 1;
pt(133).ncols     = 1;
...
pt(134).blockname = 'LKFE/EtherCAT PDO Transmit 2';
pt(134).paramname = 'P6';
pt(134).class     = 'scalar';
pt(134).nrows     = 1;
pt(134).ncols     = 1;
...
pt(136).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(136).paramname = 'P1';
pt(136).class     = 'vector';
pt(136).nrows     = 1;
pt(136).ncols     = 18;
...
pt(137).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(137).paramname = 'P2';
pt(137).class     = 'scalar';
pt(137).nrows     = 1;
pt(137).ncols     = 1;
...
pt(138).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(138).paramname = 'P3';
pt(138).class     = 'scalar';
pt(138).nrows     = 1;
pt(138).ncols     = 1;
...
pt(139).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(139).paramname = 'P4';
pt(139).class     = 'scalar';
pt(139).nrows     = 1;
pt(139).ncols     = 1;
...
pt(140).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(140).paramname = 'P5';
pt(140).class     = 'scalar';
pt(140).nrows     = 1;
pt(140).ncols     = 1;
...
pt(141).blockname = 'LKFE/EtherCAT PDO Transmit 3';
pt(141).paramname = 'P6';
pt(141).class     = 'scalar';
pt(141).nrows     = 1;
pt(141).ncols     = 1;
...
pt(143).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(143).paramname = 'P1';
pt(143).class     = 'vector';
pt(143).nrows     = 1;
pt(143).ncols     = 18;
...
pt(144).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(144).paramname = 'P2';
pt(144).class     = 'scalar';
pt(144).nrows     = 1;
pt(144).ncols     = 1;
...
pt(145).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(145).paramname = 'P3';
pt(145).class     = 'scalar';
pt(145).nrows     = 1;
pt(145).ncols     = 1;
...
pt(146).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(146).paramname = 'P4';
pt(146).class     = 'scalar';
pt(146).nrows     = 1;
pt(146).ncols     = 1;
...
pt(147).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(147).paramname = 'P5';
pt(147).class     = 'scalar';
pt(147).nrows     = 1;
pt(147).ncols     = 1;
...
pt(148).blockname = 'LKFE/EtherCAT PDO Transmit 4';
pt(148).paramname = 'P6';
pt(148).class     = 'scalar';
pt(148).nrows     = 1;
pt(148).ncols     = 1;
...
pt(150).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(150).paramname = 'P1';
pt(150).class     = 'vector';
pt(150).nrows     = 1;
pt(150).ncols     = 18;
...
pt(151).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(151).paramname = 'P2';
pt(151).class     = 'scalar';
pt(151).nrows     = 1;
pt(151).ncols     = 1;
...
pt(152).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(152).paramname = 'P3';
pt(152).class     = 'scalar';
pt(152).nrows     = 1;
pt(152).ncols     = 1;
...
pt(153).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(153).paramname = 'P4';
pt(153).class     = 'scalar';
pt(153).nrows     = 1;
pt(153).ncols     = 1;
...
pt(154).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(154).paramname = 'P5';
pt(154).class     = 'scalar';
pt(154).nrows     = 1;
pt(154).ncols     = 1;
...
pt(155).blockname = 'LKFE/EtherCAT PDO Transmit 5';
pt(155).paramname = 'P6';
pt(155).class     = 'scalar';
pt(155).nrows     = 1;
pt(155).ncols     = 1;
...
pt(157).blockname = 'LKFE/LKFE Motor Angle';
pt(157).paramname = 'P1';
pt(157).class     = 'vector';
pt(157).nrows     = 1;
pt(157).ncols     = 22;
...
pt(158).blockname = 'LKFE/LKFE Motor Angle';
pt(158).paramname = 'P2';
pt(158).class     = 'scalar';
pt(158).nrows     = 1;
pt(158).ncols     = 1;
...
pt(159).blockname = 'LKFE/LKFE Motor Angle';
pt(159).paramname = 'P3';
pt(159).class     = 'scalar';
pt(159).nrows     = 1;
pt(159).ncols     = 1;
...
pt(160).blockname = 'LKFE/LKFE Motor Angle';
pt(160).paramname = 'P4';
pt(160).class     = 'scalar';
pt(160).nrows     = 1;
pt(160).ncols     = 1;
...
pt(161).blockname = 'LKFE/LKFE Motor Angle';
pt(161).paramname = 'P5';
pt(161).class     = 'scalar';
pt(161).nrows     = 1;
pt(161).ncols     = 1;
...
pt(162).blockname = 'LKFE/LKFE Motor Angle';
pt(162).paramname = 'P6';
pt(162).class     = 'scalar';
pt(162).nrows     = 1;
pt(162).ncols     = 1;
...
pt(163).blockname = 'LKFE/LKFE Motor Angle';
pt(163).paramname = 'P7';
pt(163).class     = 'scalar';
pt(163).nrows     = 1;
pt(163).ncols     = 1;
...
pt(164).blockname = 'LKFE/LKFE Motor Velocity';
pt(164).paramname = 'P1';
pt(164).class     = 'vector';
pt(164).nrows     = 1;
pt(164).ncols     = 25;
...
pt(165).blockname = 'LKFE/LKFE Motor Velocity';
pt(165).paramname = 'P2';
pt(165).class     = 'scalar';
pt(165).nrows     = 1;
pt(165).ncols     = 1;
...
pt(166).blockname = 'LKFE/LKFE Motor Velocity';
pt(166).paramname = 'P3';
pt(166).class     = 'scalar';
pt(166).nrows     = 1;
pt(166).ncols     = 1;
...
pt(167).blockname = 'LKFE/LKFE Motor Velocity';
pt(167).paramname = 'P4';
pt(167).class     = 'scalar';
pt(167).nrows     = 1;
pt(167).ncols     = 1;
...
pt(168).blockname = 'LKFE/LKFE Motor Velocity';
pt(168).paramname = 'P5';
pt(168).class     = 'scalar';
pt(168).nrows     = 1;
pt(168).ncols     = 1;
...
pt(169).blockname = 'LKFE/LKFE Motor Velocity';
pt(169).paramname = 'P6';
pt(169).class     = 'scalar';
pt(169).nrows     = 1;
pt(169).ncols     = 1;
...
pt(170).blockname = 'LKFE/LKFE Motor Velocity';
pt(170).paramname = 'P7';
pt(170).class     = 'scalar';
pt(170).nrows     = 1;
pt(170).ncols     = 1;
...
pt(176).blockname = 'RHFE/EtherCAT PDO Receive';
pt(176).paramname = 'P6';
pt(176).class     = 'scalar';
pt(176).nrows     = 1;
pt(176).ncols     = 1;
...
pt(177).blockname = 'RHFE/EtherCAT PDO Receive';
pt(177).paramname = 'P7';
pt(177).class     = 'scalar';
pt(177).nrows     = 1;
pt(177).ncols     = 1;
...
pt(183).blockname = 'RHFE/EtherCAT PDO Receive1';
pt(183).paramname = 'P6';
pt(183).class     = 'scalar';
pt(183).nrows     = 1;
pt(183).ncols     = 1;
...
pt(184).blockname = 'RHFE/EtherCAT PDO Receive1';
pt(184).paramname = 'P7';
pt(184).class     = 'scalar';
pt(184).nrows     = 1;
pt(184).ncols     = 1;
...
pt(190).blockname = 'RHFE/EtherCAT PDO Receive2';
pt(190).paramname = 'P6';
pt(190).class     = 'scalar';
pt(190).nrows     = 1;
pt(190).ncols     = 1;
...
pt(191).blockname = 'RHFE/EtherCAT PDO Receive2';
pt(191).paramname = 'P7';
pt(191).class     = 'scalar';
pt(191).nrows     = 1;
pt(191).ncols     = 1;
...
pt(197).blockname = 'RHFE/EtherCAT PDO Transmit ';
pt(197).paramname = 'P6';
pt(197).class     = 'scalar';
pt(197).nrows     = 1;
pt(197).ncols     = 1;
...
pt(198).blockname = 'RHFE/EtherCAT PDO Transmit ';
pt(198).paramname = 'P7';
pt(198).class     = 'scalar';
pt(198).nrows     = 1;
pt(198).ncols     = 1;
...
pt(204).blockname = 'RHFE/EtherCAT PDO Transmit 1';
pt(204).paramname = 'P6';
pt(204).class     = 'scalar';
pt(204).nrows     = 1;
pt(204).ncols     = 1;
...
pt(205).blockname = 'RHFE/EtherCAT PDO Transmit 1';
pt(205).paramname = 'P7';
pt(205).class     = 'scalar';
pt(205).nrows     = 1;
pt(205).ncols     = 1;
...
pt(211).blockname = 'RHFE/EtherCAT PDO Transmit 2';
pt(211).paramname = 'P6';
pt(211).class     = 'scalar';
pt(211).nrows     = 1;
pt(211).ncols     = 1;
...
pt(212).blockname = 'RHFE/EtherCAT PDO Transmit 2';
pt(212).paramname = 'P7';
pt(212).class     = 'scalar';
pt(212).nrows     = 1;
pt(212).ncols     = 1;
...
pt(218).blockname = 'RHFE/EtherCAT PDO Transmit 3';
pt(218).paramname = 'P6';
pt(218).class     = 'scalar';
pt(218).nrows     = 1;
pt(218).ncols     = 1;
...
pt(219).blockname = 'RHFE/EtherCAT PDO Transmit 3';
pt(219).paramname = 'P7';
pt(219).class     = 'scalar';
pt(219).nrows     = 1;
pt(219).ncols     = 1;
...
pt(225).blockname = 'RHFE/EtherCAT PDO Transmit 4';
pt(225).paramname = 'P6';
pt(225).class     = 'scalar';
pt(225).nrows     = 1;
pt(225).ncols     = 1;
...
pt(226).blockname = 'RHFE/EtherCAT PDO Transmit 4';
pt(226).paramname = 'P7';
pt(226).class     = 'scalar';
pt(226).nrows     = 1;
pt(226).ncols     = 1;
...
pt(232).blockname = 'RHFE/EtherCAT PDO Transmit 5';
pt(232).paramname = 'P6';
pt(232).class     = 'scalar';
pt(232).nrows     = 1;
pt(232).ncols     = 1;
...
pt(233).blockname = 'RHFE/EtherCAT PDO Transmit 5';
pt(233).paramname = 'P7';
pt(233).class     = 'scalar';
pt(233).nrows     = 1;
pt(233).ncols     = 1;
