...
pt(23).blockname = 'EtherCAT PDO Receive3';
pt(23).paramname = 'P1';
pt(23).class     = 'vector';
pt(23).nrows     = 1;
pt(23).ncols     = 22;
...
pt(24).blockname = 'EtherCAT PDO Receive3';
pt(24).paramname = 'P2';
pt(24).class     = 'scalar';
pt(24).nrows     = 1;
pt(24).ncols     = 1;
...
pt(25).blockname = 'EtherCAT PDO Receive3';
pt(25).paramname = 'P3';
pt(25).class     = 'scalar';
pt(25).nrows     = 1;
pt(25).ncols     = 1;
...
pt(26).blockname = 'EtherCAT PDO Receive3';
pt(26).paramname = 'P4';
pt(26).class     = 'scalar';
pt(26).nrows     = 1;
pt(26).ncols     = 1;
...
pt(27).blockname = 'EtherCAT PDO Receive3';
pt(27).paramname = 'P5';
pt(27).class     = 'scalar';
pt(27).nrows     = 1;
pt(27).ncols     = 1;
...
pt(28).blockname = 'EtherCAT PDO Receive3';
pt(28).paramname = 'P6';
pt(28).class     = 'scalar';
pt(28).nrows     = 1;
pt(28).ncols     = 1;
...
pt(29).blockname = 'EtherCAT PDO Receive3';
pt(29).paramname = 'P7';
pt(29).class     = 'scalar';
pt(29).nrows     = 1;
pt(29).ncols     = 1;
...
pt(34).blockname = 'EtherCAT PDO Transmit ';
pt(34).paramname = 'P5';
pt(34).class     = 'scalar';
pt(34).nrows     = 1;
pt(34).ncols     = 1;
...
pt(35).blockname = 'EtherCAT PDO Transmit ';
pt(35).paramname = 'P6';
pt(35).class     = 'scalar';
pt(35).nrows     = 1;
pt(35).ncols     = 1;
...
pt(36).blockname = 'EtherCAT PDO Transmit ';
pt(36).paramname = 'P7';
pt(36).class     = 'scalar';
pt(36).nrows     = 1;
pt(36).ncols     = 1;
