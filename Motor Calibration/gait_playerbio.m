...
bio(29).blkName='LHFE Gait Generation/RHFE home and walk';
bio(29).sigName='';
bio(29).portIdx=0;
bio(29).dim=[1,1];
bio(29).sigWidth=1;
bio(29).sigAddress='&gait_player_B.sf_RHFEhomeandwalk.y';
bio(29).ndims=2;
bio(29).size=[];
...
bio(36).blkName='LKFE Gait Generation /RKFE home and walk';
bio(36).sigName='';
bio(36).portIdx=0;
bio(36).dim=[1,1];
bio(36).sigWidth=1;
bio(36).sigAddress='&gait_player_B.sf_RKFEhomeandwalk.y';
bio(36).ndims=2;
bio(36).size=[];
...
bio(43).dim=[1,1];
bio(43).sigWidth=1;
bio(43).sigAddress='&gait_player_B.sf_RHFEhomeandwalk_c.y';
bio(43).ndims=2;
bio(43).size=[];
...
bio(50).dim=[1,1];
bio(50).sigWidth=1;
bio(50).sigAddress='&gait_player_B.sf_RKFEhomeandwalk_f.y';
bio(50).ndims=2;
bio(50).size=[];
