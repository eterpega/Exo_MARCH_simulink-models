...
bio(1).dim=[1,1];
bio(1).sigWidth=1;
bio(1).sigAddress='&untitled_B.MotorEnable';
bio(1).ndims=2;
bio(1).size=[];
...
bio(2).dim=[1,1];
bio(2).sigWidth=1;
bio(2).sigAddress='&untitled_B.VelocityOverride';
bio(2).ndims=2;
bio(2).size=[];
...
bio(3).dim=[6,1];
bio(3).sigWidth=6;
bio(3).sigAddress='&untitled_B.EtherCATInit[0]';
bio(3).ndims=2;
bio(3).size=[];
...
bio(4).dim=[1,1];
bio(4).sigWidth=1;
bio(4).sigAddress='&untitled_B.EtherCATPDOReceiveJointAngle';
bio(4).ndims=2;
bio(4).size=[];
...
bio(5).dim=[1,1];
bio(5).sigWidth=1;
bio(5).sigAddress='&untitled_B.EtherCATPDOReceiveSpringAngle';
bio(5).ndims=2;
bio(5).size=[];
...
bio(6).dim=[1,1];
bio(6).sigWidth=1;
bio(6).sigAddress='&untitled_B.Sum_e';
bio(6).ndims=2;
bio(6).size=[];
...
bio(7).dim=[1,1];
bio(7).sigWidth=1;
bio(7).sigAddress='&untitled_B.Sum1';
bio(7).ndims=2;
bio(7).size=[];
...
bio(8).dim=[1,1];
bio(8).sigWidth=1;
bio(8).sigAddress='&untitled_B.Sum2';
bio(8).ndims=2;
bio(8).size=[];
...
bio(9).dim=[1,1];
bio(9).sigWidth=1;
bio(9).sigAddress='&untitled_B.Sum3';
bio(9).ndims=2;
bio(9).size=[];
...
bio(10).dim=[1,1];
bio(10).sigWidth=1;
bio(10).sigAddress='&untitled_B.Diff';
bio(10).ndims=2;
bio(10).size=[];
...
bio(11).dim=[1,1];
bio(11).sigWidth=1;
bio(11).sigAddress='&untitled_B.TSamp';
bio(11).ndims=2;
bio(11).size=[];
...
bio(12).dim=[1,1];
bio(12).sigWidth=1;
bio(12).sigAddress='&untitled_B.Uk1';
bio(12).ndims=2;
bio(12).size=[];
...
bio(13).dim=[1,1];
bio(13).sigWidth=1;
bio(13).sigAddress='&untitled_B.Integrator';
bio(13).ndims=2;
bio(13).size=[];
...
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&untitled_B.IOut';
bio(14).ndims=2;
bio(14).size=[];
...
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&untitled_B.POut';
bio(15).ndims=2;
bio(15).size=[];
...
bio(16).dim=[1,1];
bio(16).sigWidth=1;
bio(16).sigAddress='&untitled_B.Sum';
bio(16).ndims=2;
bio(16).size=[];
...
bio(17).dim=[1,1];
bio(17).sigWidth=1;
bio(17).sigAddress='&untitled_B.Integrator_p';
bio(17).ndims=2;
bio(17).size=[];
...
bio(18).dim=[1,1];
bio(18).sigWidth=1;
bio(18).sigAddress='&untitled_B.IOut_i';
bio(18).ndims=2;
bio(18).size=[];
...
bio(19).dim=[1,1];
bio(19).sigWidth=1;
bio(19).sigAddress='&untitled_B.POut_b';
bio(19).ndims=2;
bio(19).size=[];
...
bio(20).dim=[1,1];
bio(20).sigWidth=1;
bio(20).sigAddress='&untitled_B.Sum_a';
bio(20).ndims=2;
bio(20).size=[];
...
bio(21).dim=[1,1];
bio(21).sigWidth=1;
bio(21).sigAddress='&untitled_B.Integrator_o';
bio(21).ndims=2;
bio(21).size=[];
...
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&untitled_B.IOut_g';
bio(22).ndims=2;
bio(22).size=[];
...
bio(23).dim=[1,1];
bio(23).sigWidth=1;
bio(23).sigAddress='&untitled_B.POut_n';
bio(23).ndims=2;
bio(23).size=[];
...
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&untitled_B.Sum_o';
bio(24).ndims=2;
bio(24).size=[];
