...
[importedVars,existingVars] = importFromBaseWorkspace(myDictionaryObj,...
    ...
    ,'initializeSitDownHip','initializeSitDownKnee'...
    ,'standUpHip','standUpKnee'...
    ,'initializeStandUpHip','initializeStandUpKnee'...
    ,'stepStandLegHip','stepStandLegKnee'...
    ,'stepSwingLegHip','stepSwingLegKnee'...
    ,'stairsDownLeftHip','stairsDownLeftKnee'...
    ,'stairsDownRightHip','stairsDownRightKnee'...
    ,'stairsUpLeftHip','stairsUpLeftKnee'...
    ,'stairsUpRightHip','stairsUpRightKnee'...
    });
